...
## Solucion
- al conectarnos con el netcat que nos dan nos dan un mensaje:
```
...
```
- parece ser un cifrado en vigenere pero no tenemos la llave
- podemos buscar un cifrado de vigenere en linea y ponemos el texto ahi
- nos regresa que la llave era flag y la bandera fue : **picoCTF{b311a50_0r_v1gn3r3_c1ph3r6fe60eaa}**
## Notas
